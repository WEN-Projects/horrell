...
?>
    ...
    <main id="primary" class="site-main blog-page">
		...
		get_template_part( "template-parts/content", "title-breadcrumb", array( "title" => get_the_archive_title() ) );
		?>
                ...
                <div class="blog-list-wrapper col-lg-9 order-1 order-lg-2">
					...
					if ( have_posts() ) :
                        ...
                        <div class="pagination-wrapper d-flex justify-content-sm-end align-items-center flex-wrap">
							...
							echo isset( $paged ) && isset( $wp_query->max_num_pages ) && $paged != $wp_query->max_num_pages && $wp_query->max_num_pages > 1 ? "<a class='next' href='" . get_pagenum_link( $wp_query->max_num_pages ) . "'>››</a>" : "";
							?>
                        </div>
					<?php
					endif;
