<?php
/*
Template Name: save listing email template
*/

$recipient_name = isset( $args["form_data"]["recipient_name"] ) ? $args["form_data"]["recipient_name"] : "";
$your_name      = isset( $args["form_data"]["your_name"] ) ? $args["form_data"]["your_name"] : "";
$message        = isset( $args["form_data"]["message"] ) ? $args["form_data"]["message"] : "Horrell Company has property listings that might interest you. For additional information test";
$saved_listings = isset( $args["listings"] ) ? $args["listings"] : array();

$browser_view_url = add_query_arg( array(
	'form_data' => array( "recipient_name" => $recipient_name, "your_name" => $your_name, "message" => $message ),
	'listings'  => $saved_listings,
), get_permalink( get_page_by_path( 'browser-template' ) ) );
?>
        ...
        <tr>
            <td>
                ...
                <table align="center"
                    ...
                    <tbody>
                    <tr>
                        <td style="width: 596px; vertical-align: middle; text-align: right;" width="596">
							<?php
							$email_header_description = get_field( 'email_header_description', 'option' );
							if ( $email_header_description ) {
								echo $email_header_description;
							}
							?>
                            <a class="link" style="text-decoration: underline;" target="_blank"
                               href="<?php echo $browser_view_url; ?>"><u><?php ?><?php echo _e( 'view in browser', 'horrell' ); ?></u></a>
                            </p>
                        </td>
                    </tr>
                    </tbody>
                </table>
                <!-- Preheader content Ends-->
            </td>
        </tr>
        </tbody>
    </table>
